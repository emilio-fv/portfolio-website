...
const experienceData = [
    ...
    // Private Studio
    createExperience("Private Music Teacher", "Vazquez Studio LLC", "2016 - Present", ["Managed a studio of 30+ clients a week conducting one-on-one lessons with students of all ages (from 4 to 60+ years old) and experience (from beginner to advanced).", "Sustained a consistent year-round program by anticipating scheduling conflicts through thorough communication and accommodations with students.", "Generated curated curriculums for each student's independent needs that establishes a solid technical foundation, self-sufficiency with independent work, and achieves personal goals (auditions, competitions, scholarships, etc)."], "Chandler, AZ"), 
    // Freelance
